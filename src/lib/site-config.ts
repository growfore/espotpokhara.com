export const siteConfig = {
  ...
  contact: {
    ...
    phone: "061-591175, 9802859346, 9802859342, ",
  ...
  aboutPage: {
    whoWeAre:
      "Espot Pokhara Education and Visa Services is one of the emerging educational consultancies in Pokhara and is committed to providing information and counseling to students who aspire to pursue further education abroad. With a focus on countries like USA, Australia, Canada, the UK, Germany, France, New Zealand, Cyprus, Dubai and Malta. We take on the challenge to offer qualitative and quantitative information and help you select the best option for your further educational journey. Join us now to discover the benefits of studying abroad and get our guidance throughout your exciting journey.",
    whyChooseUs:
      "We are one of the best consultancy in Pokhara for USA, Australia, Canada, the UK, Germany, France, New Zealand, Cyprus, Dubai and Malta. Our extensive knowledge and personal experience of the international student journey enable us to truly understand your aspiration and concerns when considering studying abroad. With the available vast network and partnership, we offer a diverse range of options and opportunities that align with your educational goals.",
    messageFromDirector:
